...
public class PostgreSqlQuery extends AbstractDbQuery {
    ...
    public String tablesSql() {
        return "SELECT A.tablename, obj_description(relfilenode, 'pg_class') AS comments FROM pg_tables A, pg_class B WHERE A.schemaname='%s' AND A.tablename = B.relname and obj_description(relfilenode, 'pg_class') is not null";
    }
